...
3.2 下载客户端: HMCL主页面-"版本列表"-添加游戏目录(该目录为存储游戏文件的地方)-添加完成后，在版本列表左侧选择你刚刚创建的游戏目录-下载游戏版本-下载1.20.4

3.3 配置客户端: HMCL主页面-点击"版本列表"上方的游戏版本，勾选"启用游戏特定设置(不影响其他游戏版本)"-Java路径选择21.0.3(本指南上文所用)

3.4 启动游戏: HMCL主页面-右下角启动游戏